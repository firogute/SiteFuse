...
const CATEGORY_RULES = [
  ...
  {
    name: "video",
    pattern: /(^|\.)youtube\.com$|(^|\.)netflix\.com$|(^|\.)twitch\.tv$/i,
    default: 40,
  },
  {
    name: "gaming",
    pattern:
      /(^|\.)steamcommunity\.com$|(^|\.)roblox\.com$|(^|\.)epicgames\.com$/i,
    default: 20,
  },
  {
    name: "work",
    pattern: /(^|\.)github\.com$|(^|\.)gitlab\.com$|(^|\.)stackoverflow\.com$/i,
    default: 0,
  },
  {
    name: "news",
    pattern: /(^|\.)nytimes\.com$|(^|\.)cnn\.com$|(^|\.)bbc\.co/i,
    default: 20,
  },
];
